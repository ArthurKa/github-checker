...
> **Note**: [swagger.yml](./apps/api/public/swagger.yml) file contains API documentation. You can view it using [Swagger Editor](https://editor.swagger.io/). **Changing the contracts is not allowed.**
